...
export const questions: Question[] = [
  ...
  },
  {
    ...
    answers: [
      { text: '계획적으로 짜인 여행', type: 'J', color: '#8B5CF6' }, // purple-500
      { text: '즉흥적인 자유여행', type: 'P', color: '#F97316' }, // orange-500
    ],
  },
  {
    id: 4,
    ...
    answers: [
      { text: '논리적으로 해결하려고 한다', type: 'T', color: '#14B8A6' }, // teal-500
      { text: '감정적으로 공감하려고 한다', type: 'F', color: '#EC4899' }, // pink-500
    ],
  },
  {
    id: 5,
  ...
  },
  {
    ...
    answers: [
      { text: '직접 경험한 구체적인 사실', type: 'S', color: '#FBBF24' }, // yellow-400
      { text: '아이디어와 가능성을 상상하는 것', type: 'N', color: '#6366F1' }, // indigo-400
    ],
  },
  {
    id: 7,
    ...
    answers: [
      ...
      { text: '사람들의 감정과 상황을 고려한다.', type: 'F', color: '#F472B6' }, // pink-400
    ],
  },
  {
    id: 8,
    ...
    answers: [
      { text: '미리 철저히 계획을 세운다.', type: 'J', color: '#A78BFA' }, // purple-400
      {
  ...
  },
  {
    ...
    answers: [
      { text: '일정에 맞춰 계획적으로 진행한다.', type: 'J', color: '#8B5CF6' }, // purple-500
      {
